/* --------------------------------------------------
 * © Copyright 2023 -E Fans by Stephan
 * --------------------------------------------------*/
(function ($) {
  "use strict";
  ...
  function load_owl() {
    ...
    jQuery("#items-carousel2").owlCarousel({
      ...
      jQuery("#items-carousel3").owlCarousel({
        center: false,
        items: 4,
        rewind: true,
        margin: 25,
      ...
      jQuery("#items-carousel4").owlCarousel({
        center: false,
        items: 4,
        rewind: true,
        margin: 25,
  ...
  jQuery("#dark-mode").on("click", function () {
    if (jQuery("body").hasClass("dark-scheme")) {
      window.location.href = "https://e-fans.io/index.html";
    } else {
      window.location.href = "https://e-fans.io/02_dark-index.html";
    }
  });
